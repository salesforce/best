...
async function runBenchmarks(benchmarksBuilds, globalConfig, messager) {
    const results = [];
...
async function runBenchmark({ benchmarkName, benchmarkEntry, benchmarkSignature, projectConfig, globalConfig }, messager) {
