...
describe('mergeTracedMetrics', () => {
    ...
    test('merges trace metrics at root level', async () => {
        ...
        const expectedResults: BenchmarkResults = {
            ...
            executedIterations: 0,
            aggregate: 0,
            results: [{ type: "benchmark", metrics: { script: 30, paint: 5 }, name: "foo", startedAt: 0, aggregate: 0 }]
        }
        ...
        const expectedResults: BenchmarkResults = {
            ...
            results: [{
                ...
                nodes: [
                    ...
                    { type: "benchmark", metrics: { script: 10, paint: 20, layout: 100 }, name: "bar", startedAt: 0, aggregate: 0 }
                ]
            }]
        }
