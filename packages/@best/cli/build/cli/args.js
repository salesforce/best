...
exports.usage = 'Usage: $0 [--config=<pathToConfigFile>] [BenchmarkPathPattern]';
exports.docs = 'Documentation: https://best.lwcjs.org';
exports.options = {
    config: {
        alias: 'c',
        description: 'The path to a best config file specifying how to find ' +
    ...
    projects: {
        description: 'A list of projects to run. ' +
    ...
    clearCache: {
        default: undefined,
        description: 'Clears the configured Jest cache directory and then exits. ' +
    ...
    externalStorage: {
        default: undefined,
        description: 'This option allows to save the results in an arbitrary storage system.' +
    ...
    compareStats: {
        description: 'Compares two benchmark runs for a given commit. ' +
    ...
    runner: {
        default: 'default',
        description: 'Select the runner to execute the benchmarks.' +
