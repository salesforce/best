...
class Runner {
    ...
    runSetupAndGetUrl(benchmarkEntry, { useHttp }) {
        ...
        return new Promise(resolve => {
            const dir = path_1.dirname(benchmarkEntry);
            const file = path_1.basename(benchmarkEntry);
            const publicDir = path_1.join(dir, '../public');
    ...
    async normalizeEnvironment(browser, projectConfig, globalConfig) {
        ...
        const { system, cpu, os, load } = await utils_1.getSystemInfo();
        return {
