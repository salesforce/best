...
`.replace(/(\r\n|\r|\n)/g, '\r\n');
function generateParametrizedHTML(html, options) {
    return html.replace(REGEX_BRACKETS, (m, p) => options[p] || `{{undefined_${p}}}`);
}
exports.generateParametrizedHTML = generateParametrizedHTML;
function generateDefaultHTML(options) {
...
exports.generateDefaultHTML = generateDefaultHTML;
//# sourceMappingURL=html-templating.js.map