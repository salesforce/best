...
# [4.0.0-alpha2](https://git.soma.salesforce.com/lwc/best/compare/v4.0.0-alpha1...v4.0.0-alpha2) (2019-07-26)


### Bug Fixes

* performance comment ([#176](https://git.soma.salesforce.com/lwc/best/issues/176)) ([52d9d3e](https://git.soma.salesforce.com/lwc/best/commits/52d9d3e))
* Proper handling of authentication error ([#180](https://git.soma.salesforce.com/lwc/best/issues/180)) ([7d6baa9](https://git.soma.salesforce.com/lwc/best/commits/7d6baa9))
* tokens don't expire by default ([#179](https://git.soma.salesforce.com/lwc/best/issues/179)) ([c743277](https://git.soma.salesforce.com/lwc/best/commits/c743277))


### Features

* Agent & Hub Frontend ([#178](https://git.soma.salesforce.com/lwc/best/issues/178)) ([7c5c22e](https://git.soma.salesforce.com/lwc/best/commits/7c5c22e))
* Proxy Support ([#177](https://git.soma.salesforce.com/lwc/best/issues/177)) ([29420b8](https://git.soma.salesforce.com/lwc/best/commits/29420b8))



# [4.0.0-alpha1](https://git.soma.salesforce.com/lwc/best/compare/v0.7.1...v4.0.0-alpha1) (2019-07-19)


### Bug Fixes

* add back commitInfo actions ([4fa4254](https://git.soma.salesforce.com/lwc/best/commits/4fa4254))
* add first cli test ([8df8d23](https://git.soma.salesforce.com/lwc/best/commits/8df8d23))
* add types to calculateAverageChange in gh-integration ([d357d03](https://git.soma.salesforce.com/lwc/best/commits/d357d03))
* allow any benchmark name ([71d4369](https://git.soma.salesforce.com/lwc/best/commits/71d4369))
* almost done with types for analyzer ([91ecf4f](https://git.soma.salesforce.com/lwc/best/commits/91ecf4f))
* and more types ([1d70187](https://git.soma.salesforce.com/lwc/best/commits/1d70187))
* better config types ([59110c5](https://git.soma.salesforce.com/lwc/best/commits/59110c5))
* clean command and add build/dist to gitignore ([#154](https://git.soma.salesforce.com/lwc/best/issues/154)) ([7f3cf58](https://git.soma.salesforce.com/lwc/best/commits/7f3cf58))
* cleanup runner ([57223c0](https://git.soma.salesforce.com/lwc/best/commits/57223c0))
* clear logs ([cdfe267](https://git.soma.salesforce.com/lwc/best/commits/cdfe267))
* config types ([097222d](https://git.soma.salesforce.com/lwc/best/commits/097222d))
* config types ([b21bfa3](https://git.soma.salesforce.com/lwc/best/commits/b21bfa3))
* don't overwrite error messages ([d8d0cfa](https://git.soma.salesforce.com/lwc/best/commits/d8d0cfa))
* fix tests based on code review ([2317adc](https://git.soma.salesforce.com/lwc/best/commits/2317adc))
* fix thumbs up/down in fixture ([9a17cd4](https://git.soma.salesforce.com/lwc/best/commits/9a17cd4))
* json stringifycation ([335e489](https://git.soma.salesforce.com/lwc/best/commits/335e489))
* minor cleanup ([ded739e](https://git.soma.salesforce.com/lwc/best/commits/ded739e))
* minor type corrections ([523e443](https://git.soma.salesforce.com/lwc/best/commits/523e443))
* missing types in builder,console-stream and store ([#163](https://git.soma.salesforce.com/lwc/best/issues/163)) ([1359d13](https://git.soma.salesforce.com/lwc/best/commits/1359d13))
* more result tyeps ([ea90ae3](https://git.soma.salesforce.com/lwc/best/commits/ea90ae3))
* more types ([5556ea6](https://git.soma.salesforce.com/lwc/best/commits/5556ea6))
* more types ([edb9d25](https://git.soma.salesforce.com/lwc/best/commits/edb9d25))
* more types ([91dc56e](https://git.soma.salesforce.com/lwc/best/commits/91dc56e))
* refactor @best/agent using types ([#161](https://git.soma.salesforce.com/lwc/best/issues/161)) ([5578e41](https://git.soma.salesforce.com/lwc/best/commits/5578e41))
* refactor runner ([4cc0527](https://git.soma.salesforce.com/lwc/best/commits/4cc0527))
* remove "metric: duration" from github agent comment ([21cd1df](https://git.soma.salesforce.com/lwc/best/commits/21cd1df))
* stats ([ea9adc0](https://git.soma.salesforce.com/lwc/best/commits/ea9adc0))
* types ([#162](https://git.soma.salesforce.com/lwc/best/issues/162)) ([5801a33](https://git.soma.salesforce.com/lwc/best/commits/5801a33))
* Update CI for v4 ([#168](https://git.soma.salesforce.com/lwc/best/issues/168)) ([0bd8075](https://git.soma.salesforce.com/lwc/best/commits/0bd8075))
* use performance.mark/measure instead of console.timeStamp() ([0daf847](https://git.soma.salesforce.com/lwc/best/commits/0daf847))


### Features

* add console-stream ([39f12e2](https://git.soma.salesforce.com/lwc/best/commits/39f12e2))
* Add Paint and Layout Metrics ([#171](https://git.soma.salesforce.com/lwc/best/issues/171)) ([68ae0a5](https://git.soma.salesforce.com/lwc/best/commits/68ae0a5))
* add types for analysis ([baf1f42](https://git.soma.salesforce.com/lwc/best/commits/baf1f42))
* add types for Cli ([b3f0b42](https://git.soma.salesforce.com/lwc/best/commits/b3f0b42))
* adding declarationMaps ([f9c9713](https://git.soma.salesforce.com/lwc/best/commits/f9c9713))
* Adds agent-hub and runner-hub and run-in-batch cli arg ([#169](https://git.soma.salesforce.com/lwc/best/issues/169)) ([45d96cc](https://git.soma.salesforce.com/lwc/best/commits/45d96cc))
* Agent Frontend ([#174](https://git.soma.salesforce.com/lwc/best/issues/174)) ([e7fb568](https://git.soma.salesforce.com/lwc/best/commits/e7fb568))
* Compare Output & Github Comparison Table ([#164](https://git.soma.salesforce.com/lwc/best/issues/164)) ([a96c14c](https://git.soma.salesforce.com/lwc/best/commits/a96c14c))
* Decoupled API DB with SQLite Adapter ([#158](https://git.soma.salesforce.com/lwc/best/issues/158)) ([ec156b7](https://git.soma.salesforce.com/lwc/best/commits/ec156b7))
* Default to SQLite Database & Better Migrations ([#166](https://git.soma.salesforce.com/lwc/best/issues/166)) ([3fec8e9](https://git.soma.salesforce.com/lwc/best/commits/3fec8e9))
* docs initial design ([#173](https://git.soma.salesforce.com/lwc/best/issues/173)) ([3c812d6](https://git.soma.salesforce.com/lwc/best/commits/3c812d6))
* first config types ([f71b412](https://git.soma.salesforce.com/lwc/best/commits/f71b412))
* Frontend Enhancement ([#165](https://git.soma.salesforce.com/lwc/best/issues/165)) ([788844d](https://git.soma.salesforce.com/lwc/best/commits/788844d))
* move all types to new package ([23a4cbf](https://git.soma.salesforce.com/lwc/best/commits/23a4cbf))
* New Frontend Dashboard ([#155](https://git.soma.salesforce.com/lwc/best/issues/155)) ([5b4397b](https://git.soma.salesforce.com/lwc/best/commits/5b4397b))
* New GitHub Integration & Typed Compare ([#159](https://git.soma.salesforce.com/lwc/best/issues/159)) ([e7f89e6](https://git.soma.salesforce.com/lwc/best/commits/e7f89e6))
* parallelize benchmarks build ([#170](https://git.soma.salesforce.com/lwc/best/issues/170)) ([4b679aa](https://git.soma.salesforce.com/lwc/best/commits/4b679aa))
* refactor builder stream ([41c39d2](https://git.soma.salesforce.com/lwc/best/commits/41c39d2))
* result types ([f4f385b](https://git.soma.salesforce.com/lwc/best/commits/f4f385b))
* Static Frontend ([#160](https://git.soma.salesforce.com/lwc/best/issues/160)) ([893d8cf](https://git.soma.salesforce.com/lwc/best/commits/893d8cf))
* wrap comments from github bot in details/summary ([ab3c960](https://git.soma.salesforce.com/lwc/best/commits/ab3c960))
...
## [0.6.4](https://git.soma.salesforce.com/lwc/best/compare/v0.6.3...v0.6.4) (2018-09-25)


### Bug Fixes

* correctly use rollup cache ([324cde7](https://git.soma.salesforce.com/lwc/best/commits/324cde7))
